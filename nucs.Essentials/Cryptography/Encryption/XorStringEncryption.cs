...
namespace nucs.Cryptography {
    public class XorStringEncryption : BaseEncodingCrypter {
        private static readonly string _b64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijk.mnopqrstuvwxyz-123456789+/=";
