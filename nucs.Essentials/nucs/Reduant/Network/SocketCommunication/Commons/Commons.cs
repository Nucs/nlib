...
namespace nucs.Network.SocketCommunication {
    #region Delegates
    ...
    public static class Constants {
        ...
        public static readonly string StartMessage = "<msg>";
        public static readonly string EndMessage = "</msg>";
        ...
        public static Message Translate(string message) {
            ...
            if (string.IsNullOrEmpty(message))
                return new Message {
                    Failed = true,
                    FailReason =
                        "Couldn't find closures of the message: " + Constants.StartMessage + " and " +
                        Constants.EndMessage + "."
                };
            int a;
            var @class = message.Substring(0, a = message.IndexOf(Constants.Split_ClassText, StringComparison.Ordinal));
            a += Constants.Split_Variable.Length;
            string @text = "";

            try {
                @text = message.Substring(a, message.IndexOf(Constants.StartVariable, a, StringComparison.Ordinal) - a);
            }
            catch {
                try {
    ...
    public static class Sockets {
        ...
        public static bool Compare(Socket a, Socket b, bool IfDisposedReturnTrue) {
            try {
    ...
    public class OnMessageArrivalArgs {
        ...
        public List<string> Variables {
            get { return (Message.Variables ?? new List<string>()).ToList(); }
        }
    ...
    public struct AsyncEventArgs {
        ...
        /// </summary>
        public static AsyncEventArgs Create(Socket socket) {
        ...
        /// </summary>
        public static AsyncEventArgs Create(Socket socket, byte[] buffer) {
