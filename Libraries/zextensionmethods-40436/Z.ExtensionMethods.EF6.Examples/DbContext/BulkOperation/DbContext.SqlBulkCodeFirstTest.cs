...
{
    [TestClass]
    public class DbContext_SqlBulKCodeFirstTest
    {
        [TestMethod]
        public void SqlBulKCodeFirstTest()
        {
            // Test Complex
            ...
            {
                // Unit Test
                var result = ctx.ComplexTypes.First();
            ...
            {
                // Unit Test
                var result = (EntityTPC1)ctx.EntityTPCs.First();
                Assert.AreEqual("BulkDescription", result.Description);
            ...
            {
                // Unit Test
                var result = (EntityTPH1)ctx.EntityTPHs.First();
                Assert.AreEqual("BulkDescription", result.Description);
            ...
            {
                // Unit Test
                var result = ctx.EntityWithTypeIdInts.First();
                Assert.AreEqual("BulkDescription", result.Description);
            }
            ...
            {
                // Unit Test
                var result = ctx.EntityWithTypeIdGuids.First();
                Assert.AreEqual("BulkDescription", result.Description);
            }
            ...
            {
                // Unit Test
                var result = ctx.EntityWithAllColumns.First();
