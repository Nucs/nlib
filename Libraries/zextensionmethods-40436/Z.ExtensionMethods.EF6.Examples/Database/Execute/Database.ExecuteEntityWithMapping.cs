...
{
    [TestClass]
    public class Database_ExecuteEntityWithMapping
    {
        [TestMethod]
        public void ExecuteEntityWithMapping()
        {
            // Test Complex
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<ComplexType>("SELECT * FROM ComplexTypeTable");
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<EntityTPC1>("SELECT * FROM EntityTPC1Table");
                Assert.AreEqual("BulkDescription", result.Description);
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<EntityTPH1>("SELECT * FROM EntityTPHs");
                Assert.AreEqual("BulkDescription", result.Description);
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<EntityWithTypeIdInt>("SELECT * FROM EntityWithTypeIdInts");
                Assert.AreEqual("BulkDescription", result.Description);
            }
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<EntityWithTypeIdGuid>("SELECT * FROM EntityWithTypeIdGuids");
                Assert.AreEqual("BulkDescription", result.Description);
            }
            ...
            {
                // Unit Test
                var result = ctx.Database.ExecuteEntityWithMapping<EntityWithAllColumn>("SELECT * FROM EntityWithAllColumns");
