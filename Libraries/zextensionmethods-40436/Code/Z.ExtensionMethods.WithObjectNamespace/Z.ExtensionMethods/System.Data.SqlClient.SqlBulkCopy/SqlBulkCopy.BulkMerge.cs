...
public static partial class SqlBulkCopyExtension
{
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataRow[] drs)
    {
        if (drs.Length > 0)
        {
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataRow[] drs, IEnumerable<string> primaryKeyColumnNames)
    {
        if (drs.Length > 0)
        {
            var bulkOperation = new SqlBulkOperation
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataTable dt)
    {
        if (dt.Rows.Count > 0)
        {
            var bulkOperation = new SqlBulkOperation
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataTable dt, IEnumerable<string> primaryKeyColumnNames)
    {
        if (dt.Rows.Count > 0)
        {
            var bulkOperation = new SqlBulkOperation
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataTable dt, DataRowState state)
    {
        if (dt.Rows.Count > 0)
        {
            var bulkOperation = new SqlBulkOperation
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, DataTable dt, DataRowState state, IEnumerable<string> primaryKeyColumnNames)
    {
        if (dt.Rows.Count > 0)
        {
            var bulkOperation = new SqlBulkOperation
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, IDataReader reader)
    {
        var bulkOperation = new SqlBulkOperation
            {
                SqlBulkCopy = obj,
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge(this SqlBulkCopy obj, IDataReader reader, IEnumerable<string> primaryKeyColumnNames)
    {
        var bulkOperation = new SqlBulkOperation
            {
                SqlBulkCopy = obj,
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge<T>(this SqlBulkCopy obj, IEnumerable<T> entities)
    {
        var bulkOperation = new SqlBulkOperation
            {
                SqlBulkCopy = obj,
    ...
    ///     </code>
    /// </example>
    public static void BulkMerge<T>(this SqlBulkCopy obj, IEnumerable<T> entities, IEnumerable<string> primaryKeyColumnNames)
    {
        var bulkOperation = new SqlBulkOperation
            {
                SqlBulkCopy = obj,
