...
namespace Z.ExtensionMethods.Object.Serialization {
    public static partial class ObjectExtension {
        ...
        ///     </code>
        /// </example>
        public static string SerializeJavaScript<T>(this T @this, params JavaScriptConverter[] converters)
        {
            var serializer = new JavaScriptSerializer();
        ...
        ///     </code>
        /// </example>
        public static string SerializeJavaScript<T>(this T @this, IEnumerable<JavaScriptConverter> converters) {
            var serializer = new JavaScriptSerializer();
            serializer.RegisterConverters(converters);
            return serializer.Serialize(@this);
        }
