...
namespace nucs.SystemCore {
    internal static class CodeGen {
        ...
        /// </summary>
        internal static string CODE_PREGENERATION_OUTPUT = "D:/coderunner-genned.txt";
        /// <summary>
        /// How deep to include namespaces, "System.Images" is length of 2. "System.Images.Crazy" is length of 2.
        /// </summary>
        internal static int NAMESPACE_LENGHT_LIMIT = 10;
        ...
        /// </param>
        internal static CodeGenerated Generate(string code, string filename, FileOutputExtension extension = FileOutputExtension.DLL, bool includeNamespaces = true) {
    ...
    /// </summary>
    internal class CodeGenerated : IDisposable {
        ...
        /// </summary>
        internal bool CompiledSuccessfully {
        ...
        /// </summary>
        internal List<CompilerError> Errors { get; private set; }
    ...
    /// </summary>
    internal enum FileOutputExtension {
        [Description(".dll")]
        DLL,
        [Description(".exe")]
        EXE
    ...
    [Serializable]
    internal class PostCompilationException : CompilerError {
        internal PostCompilationException() { }
        internal PostCompilationException(string message) : base("",0,0,"None", message) { }
    }
