...
namespace BotSuite.DataTypes {
    ...
    public struct Hex32 : IEquatable<Hex32>, IComparable<Hex32> {
        ...
        public Hex32(Int32 i) { this.IntValue = i; }
        ...
        /// <param name="i">The i.</param>
        /// <returns></returns>
        public static implicit operator Hex32(Int32 i) { return new Hex32(i); }
        ...
        /// <returns></returns>
        public static implicit operator Int32(Hex32 h) { return h.IntValue; }
        ...
        /// </returns>
        public override string ToString() { return "0x" + this.IntValue.ToString("X"); }
        ...
        /// </returns>
        public override int GetHashCode() { return this.IntValue*0x00010000 + this.IntValue; }
        ...
        /// </returns>
        public override bool Equals(object obj) { return this.Equals((Hex32) obj); }
        ...
        /// </returns>
        public bool Equals(Hex32 other) { return Object.ReferenceEquals(this, other) || ((this.GetType() == other.GetType()) && this.IntValue.Equals(other.IntValue)); }
        ...
        /// </returns>
        public int CompareTo(Hex32 other) { return this.IntValue.CompareTo(other.IntValue); }
        ...
        /// <returns></returns>
        public static Hex32 operator +(Hex32 h1, Hex32 h2) { return new Hex32(h1.IntValue + h2.IntValue); }
        ...
        /// <param name="h2">The h2.</param>
        /// <returns></returns>
        public static bool operator ==(Hex32 h1, Hex32 h2) { return h1.Equals(h2); }
        ...
        /// <param name="h2">The h2.</param>
        /// <returns></returns>
        public static bool operator !=(Hex32 h1, Hex32 h2) { return !(h1 == h2); }
        ...
        /// <param name="h2">The h2.</param>
        /// <returns></returns>
        public static bool operator >(Hex32 h1, Hex32 h2) { return (h1.CompareTo(h2) > 0); }
