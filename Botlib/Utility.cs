...
namespace BotSuite {
    ...
    public class Utility {
        ...
        /// <returns></returns>
        public static void Delay(Int32 lower = 10, Int32 upper = 30) { Thread.Sleep(Random(lower, upper)); }

        /// <summary>
        /// pause the current thread for x ms
        /// </summary>
        /// <returns></returns>
        public static void Delay(Int32 x = 10000) { Thread.Sleep(x); }
...
//         }
        ...
        public static Int32 Random(Int32 lower, Int32 upper) { return _random.Next(lower, upper); }
        ...
        public static Double Random(Double lower, Double upper) { return _random.NextDouble()*((upper - lower) + lower); }
    }
}