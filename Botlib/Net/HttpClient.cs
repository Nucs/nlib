...
namespace BotSuite.Net {
    ...
    public class HttpClient {
        ...
        public TRespType POST<TRespType>(String url, HttpPostDataCollection postdata, String referer = null) where TRespType : class { return this.POST<TRespType>(url, postdata.ToString(), referer); }
