...
namespace BotSuite.Net {
    ...
    public class HttpPostDataCollection : ICollection<HttpPostData> {
        ...
        /// </summary>
        public HttpPostDataCollection() { this._PostData = new List<HttpPostData>(); }
        ...
        public Boolean Contains(HttpPostData item) { return this._PostData.Contains(item); }
        ...
        public void CopyTo(HttpPostData[] array, Int32 arrayIndex) { this._PostData.CopyTo(array, arrayIndex); }

        /// <summary>
        /// Gets the amount of items in the collection
        /// </summary>
        public Int32 Count {
            get { return this._PostData.Count; }
        }
        ...
        public Boolean Remove(HttpPostData item) { return this._PostData.Remove(item); }

        /// <summary>
        /// returns the IEnumerator&lt;HttpPostData&gt; of this collection
        /// </summary>
        /// <returns>an Enumerator of this collection</returns>
        public IEnumerator<HttpPostData> GetEnumerator() { return this._PostData.GetEnumerator(); }
        ...
        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() { return (System.Collections.IEnumerator) this.GetEnumerator(); }
