...
namespace BotSuite.Net {
    ...
    public class HttpHeader : IEquatable<HttpHeader>, IComparable<HttpHeader> {
        ...
        public Boolean Equals(HttpHeader other) { return this.Key.Equals(other.Key); }
        ...
        public Int32 CompareTo(HttpHeader other) { return this.Key.CompareTo(other.Key); }
        ...
        public override String ToString() { return "HttpHeader->{" + this.Key + ": " + this.Value + "}"; }
    }
}