...
namespace BotSuite.Recognition.Character {
    ...
    public class MagicMatchSticks {
        ...
        public int Num() { return MagicStickList.Count; }
        ...
        /// <returns></returns>
        public void Add(MagicMatchStick Stick) { MagicStickList.Add(Stick); }
        ...
        /// </summary>
        /// <returns></returns>
        public MagicMatchSticks() { MagicStickList = new List<MagicMatchStick> {}; }
