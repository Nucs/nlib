...
namespace BotSuite {
    ...
    public class ControlArtist {
        ...
        /// <returns></returns>
        public void DrawRectangle(int LeftMargin, int TopMargin, int RightMargin = 0, int BottomMargin = 0) { formGraphics.DrawRectangle(new Pen(Color.Blue), new Rectangle(LeftMargin, TopMargin, ClientRectangle.Width - LeftMargin - RightMargin, ClientRectangle.Height - TopMargin - BottomMargin)); }
        ...
        /// <param name="BottomMargin">margin from bottom(default: 0)</param>
        /// <returns></returns>
        public Rectangle GetDrawRectangle(int LeftMargin, int TopMargin, int RightMargin, int BottomMargin) { return new Rectangle(LeftMargin, TopMargin, ClientRectangle.Width - LeftMargin - RightMargin, ClientRectangle.Height - TopMargin - BottomMargin); }
