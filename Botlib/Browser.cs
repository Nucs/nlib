...
namespace BotSuite {
    ...
    public class Browser {
        ...
        /// <param name="e"></param>
        protected void SetBrowserCompleted(object sender, WebBrowserDocumentCompletedEventArgs e) { FullLoaded = true; }
        ...
        /// <returns></returns>
        public void FillInputById(string id, string value) { Instance.Document.GetElementById(id).SetAttribute("value", value); }
...
//         }
        ...
        public string GetInnerTextById(string id) { return Instance.Document.GetElementById(id).InnerText; }
