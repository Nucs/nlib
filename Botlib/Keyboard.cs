...
namespace BotSuite {
    ...
    public class Keyboard {
        ...
        static Keyboard() { _instance = new Keyboard(); }
        ...
        /// this is a private method. You cannot us it! See the constructor #ctor for an example.
        /// </remarks>
        private void unhook() { NativeMethods.UnhookWindowsHookEx(hhook); }
        ...
        /// <returns></returns>
        public static void Type(String Sequence) { SendKeys.Send(Sequence.Trim()); }
        ...
        public static void TypeToHiddenWindow(Keys[] Key, IntPtr hWnd) { Key.ToList().ForEach(k => { TypeToHiddenWindow(k, hWnd); }); }
        ...
        public static Boolean IsKeyDown(Keys key) { return (NativeMethods.GetAsyncKeyState(key) == Int16.MinValue); }
    }
}