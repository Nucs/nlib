...
namespace nucs.Automation.Fluent {
    ...
    public class FluentTemplate<TInvoker> : ICloneable where TInvoker : FluentInvoker {
        ...
        /// <summary>
        ///     Blocks the thread for the given miliseconds
        /// </summary>
        /// <param name="milliseconds">miliseconds</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(int milliseconds) {
            Chain((inv, tmp) => Invoker.Wait(milliseconds));
            return this;
        }
        ...
        /// <param name="milliseconds">miliseconds</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(WaitHandle handle, int milliseconds) {
            Chain((inv, tmp) => Invoker.Wait(handle, milliseconds));
            return this;
        }
        ...
        /// <param name="milliseconds">miliseconds</param>
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(ManualResetEvent @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, milliseconds, onfalse));
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(ManualResetEventSlim @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, milliseconds, onfalse));
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(AutoResetEvent @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, milliseconds, onfalse));
            return this;
        }
        ...
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(TimeSpan time) {
            Chain((inv, tmp) => Invoker.Wait(time));
            return this;
        }
        ...
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(WaitHandle handle, TimeSpan time) {
            Chain((inv, tmp) => Invoker.Wait(handle, time));
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(ManualResetEvent @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, time, onfalse));
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(ManualResetEventSlim @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, time, onfalse));
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentTemplate<TInvoker> Wait(AutoResetEvent @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            Chain((inv, tmp) => Invoker.Wait(@event, time, onfalse));
            return this;
        }
