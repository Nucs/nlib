...
namespace nucs.Automation.Fluent {
    public class FluentInvoker {
        ...
        /// <returns></returns>
        public FluentInvoker Wait(int milliseconds) {
        ...
        /// <param name="milliseconds">miliseconds</param>
        /// <returns></returns>
        public FluentInvoker Wait(WaitHandle handle, int milliseconds) {
        ...
        /// <returns></returns>
        public FluentInvoker Wait(ManualResetEvent @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
            if (!@event.WaitOne(milliseconds)) {
                onfalse?.Invoke(this);
            }
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentInvoker Wait(ManualResetEventSlim @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentInvoker Wait(AutoResetEvent @event, int milliseconds = -1, Action<FluentInvoker> onfalse = null) {
            if (!@event.WaitOne(milliseconds)) {
                onfalse?.Invoke(this);
            }
            return this;
        ...
        /// <returns></returns>
        public FluentInvoker Wait(TimeSpan time) {
            Thread.Sleep(time);
            return this;
        }
        ...
        /// <returns></returns>
        public FluentInvoker Wait(WaitHandle handle, TimeSpan time) {
            if (handle == null) throw new ArgumentNullException(nameof(handle));
            handle.WaitOne(time);
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentInvoker Wait(ManualResetEvent @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            if (!@event.WaitOne(time)) {
                onfalse?.Invoke(this);
            }
            return this;
        }
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentInvoker Wait(ManualResetEventSlim @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            if (!@event.Wait(time)) {
                onfalse?.Invoke(this);
            }
            return this;
        ...
        /// <param name="onfalse">If false is returned from the invoker, do something..., can be null</param>
        /// <returns></returns>
        public FluentInvoker Wait(AutoResetEvent @event, TimeSpan time, Action<FluentInvoker> onfalse = null) {
            if (!@event.WaitOne(time)) {
                onfalse?.Invoke(this);
            }
            return this;
