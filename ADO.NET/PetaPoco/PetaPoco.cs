...
namespace PetaPoco {
    ...
    public partial class Database : IDisposable {
                ...
                try {
                    using (var cmd = CreateCommand(_sharedConnection, "")) {
                        ...
                        cmd.CommandText = string.Format("INSERT INTO {0} ({1}){2} VALUES ({3})",
                                                        ...
                                                        string.Join(",", names.ToArray()), outputClause,
        ...
        public int Delete(string tableName, string primaryKeyName, object poco, object primaryKeyValue) {
            ...
            // Do it
            var sql = string.Format("DELETE FROM {0} WHERE {1}=@0", _dbType.EscapeTableName(tableName),
	...
	*/
    ...
    namespace Internal {
        ...
        internal class MultiPocoFactory {
            ...
            private static Func<IDataReader, object, TRet> CreateMultiPocoFactory<TRet>(Type[] types,
                ...
                for (int i = 0; i < types.Length; i++) {
                    ...
                    var del = FindSplitPoint(types[i], i + 1 < types.Length ? types[i + 1] : null, ConnectionString, sql,
                                             r, ref pos);
                    dels.Add(del);
                ...
                return
                    ...
                    m.CreateDelegate(typeof (Func<IDataReader, object, TRet>),
            ...
            public static Func<IDataReader, object, TRet> GetFactory<TRet>(Type[] types, string ConnectionString,
                                                                           string sql, IDataReader r) {
                var key = Tuple.Create<Type, ArrayKey<Type>, string, string>(typeof (TRet), new ArrayKey<Type>(types),
                ...
                return PocoFactories.Get(key, () => {
                                                  ...
                                                  if (type == typeof (object)) {
                                                      ...
                                                      il.Emit(OpCodes.Newobj,
                                                              typeof (System.Dynamic.ExpandoObject).GetConstructor(
                                                                  Type.EmptyTypes)); // obj
                                                      ...
                                                      for (int i = firstColumn; i < firstColumn + countColumns; i++) {
                                                          ...
                                                          Func<object, object> converter =
                                                              mapper.GetFromDbConverter((PropertyInfo) null, srcType);
							...
							*/
                                                          ...
                                                          for (int i = firstColumn; i < firstColumn + countColumns; i++) {
                                                              ...
                                                              if (!Handled) {
                                                                  ...
                                                                  il.Emit(OpCodes.Unbox_Any,
                                                                      ...
                                                                      // poco,poco,value
                                                                  il.Emit(OpCodes.Callvirt,
                                                                          pc.PropertyInfo.GetSetMethod(true)); // poco
                                                              }
                                                  ...
                                                  // Cache it, return it
                                                  return
                                                      m.CreateDelegate(Expression.GetFuncType(typeof (IDataReader), type));
                                              });
            }
        ...
        internal static class EnumMapper {
            ...
            private static Cache<Type, Dictionary<string, object>> _types =
            ...
            public static string ProcessParams(string sql, object[] args_src, List<object> args_dest) {
                return rxParams.Replace(sql, m => {
                                                 ...
                                                 if ((arg_val as System.Collections.IEnumerable) != null &&
                                                     (arg_val as string) == null && (arg_val as byte[]) == null) {
                                                     var sb = new StringBuilder();
