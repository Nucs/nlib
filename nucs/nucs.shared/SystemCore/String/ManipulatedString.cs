...
namespace StringManipulator {
    public class ManipulatedString { 
        ...
        public ManipulatedString(string str, StringComparison comparison = StringComparison.InvariantCultureIgnoreCase)
        {
            _src = str;
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString SkipUntill(string str) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString Skip(int chars) {
            if (reachedend) return this;
            if (chars == 0)
                return this;
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString EndBack(int chars) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString EndForward(int chars) {
            var newec = endcursor + chars;
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString Forward(int chars) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString Back(int chars) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString ShiftRight(int chars) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString ShiftLeft(int chars) {
        ...
        /// </summary>
        /// <returns></returns>
        public ManipulatedString TillEnd() {
            if (reachedend) return this;
        ...
        public ManipulatedString Till(string str, bool endifnotfound = false) {
            if (reachedend) return this;
    ...
    public static class ManipulatedStringExtensions {
        public static ManipulatedString Manipulate(this string str) {
        ...
        /// <param name="end"></param>
        /// <returns></returns>
        public static IEnumerable<string> AllBetween(this string src, string start, string end) {
