...
public static partial class DirectoryInfoExtension
{
    ...
    {
#if (NET_3_5 || NET_3_0 || NET_2_0)
        return Directory.GetFileSystemEntries(@this.FullName).Where(x => predicate(x)).ToArray();
#else
    ...
    {
#if (NET_3_5 || NET_3_0 || NET_2_0)
        return Directory.GetFileSystemEntries(@this.FullName, searchPattern).Where(x => predicate(x)).ToArray();
#else
