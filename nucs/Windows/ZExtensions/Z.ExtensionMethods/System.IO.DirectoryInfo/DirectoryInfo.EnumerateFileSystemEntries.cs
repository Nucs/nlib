...
public static partial class DirectoryInfoExtension
{
    ...
    {
        return Directory.GetFileSystemEntries(@this.FullName);
    }
    ...
    public static IEnumerable<string> EnumerateFileSystemEntries(this DirectoryInfo @this, String searchPattern)
    {
        ...
        return Directory.GetFileSystemEntries(@this.FullName, searchPattern);
#else
    ...
    {
        return Directory.GetFileSystemEntries(@this.FullName, searchPattern, searchOption);
    ...
    {
        return searchPatterns.SelectMany(x => Directory.GetFileSystemEntries(@this.FullName, x, searchOption)).Distinct();
    }
#endif
