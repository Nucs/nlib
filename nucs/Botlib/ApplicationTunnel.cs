...
namespace BotSuite {
    ...
    public class ApplicationTunnel {
        ...
        /// destructor
        /// </summary>
        ~ApplicationTunnel() { DetachProcess(); }
        ...
        /// <returns></returns>
        public static Process[] GetProcessIdByName(string name) { return Process.GetProcessesByName(name); }
        ...
        public static int Hex2Int(string hex) { return Int32.Parse(hex, System.Globalization.NumberStyles.HexNumber); }
        ...
        protected void AttachProcess() {
            ...
            NativeMethods.ProcessAccessType AccessFlags = NativeMethods.ProcessAccessType.PROCESS_VM_READ | NativeMethods.ProcessAccessType.PROCESS_VM_WRITE | NativeMethods.ProcessAccessType.PROCESS_VM_OPERATION;
        ...
        public void WriteAscii(int pAddress, string StringToWrite) { WriteMemoryAtAdress((IntPtr) pAddress, Encoding.ASCII.GetBytes(StringToWrite + "\0")); }
        ...
        /// <param name="pAddress">address to write</param>
        /// <param name="StringToWrite">string to write</param>
        public void WriteUnicode(int pAddress, string StringToWrite) { WriteMemoryAtAdress((IntPtr) pAddress, Encoding.Unicode.GetBytes(StringToWrite + "\0")); }
        ...
        /// </summary>
        /// <returns></returns>
        public IntPtr GetHandle() { return ProcessHandle; }
