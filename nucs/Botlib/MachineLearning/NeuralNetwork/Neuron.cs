...
namespace BotSuite.MachineLearning.NeuralNetwork {
    ...
    public class Neuron {
        ...
        public float this[int NeuronIdx] {
            ...
            set {
                _remember_weight[NeuronIdx] = _weight[NeuronIdx];
                _weight[NeuronIdx] = value;
            }
        }
        ...
        public float Threshold {
            ...
            set {
                _remember_threshold = _threshold;
                _threshold = value;
            }
        }
        ...
        /// </summary>
        public void ShuffleThreshold() { _threshold = _intervall_min + (((float) (prng.Next(1000)))/1000f)*(_intervall_max - _intervall_min); }
