...
namespace BotSuite {
    ...
    public class Window {
        ...
        /// <returns></returns>
        public static Boolean SetFrontWindow(String WindowName) { return NativeMethods.SetForegroundWindow(FindWindowByWindowTitle(WindowName)); }
        ...
        /// <returns></returns>
        public static void ShowWindow(IntPtr WindowHandle) { NativeMethods.ShowWindow(WindowHandle, 9); }
