...
namespace BotSuite.Net {
    ...
    public class HttpPostData : IEquatable<HttpPostData>, IComparable<HttpPostData> {
        ...
        public override String ToString() { return String.Concat(System.Web.HttpUtility.UrlEncode(this._Key), '=', System.Web.HttpUtility.UrlEncode(this._Value)); }
        ...
        public Boolean Equals(HttpPostData other) { return this._Key.Equals(other._Key); }
        ...
        public Int32 CompareTo(HttpPostData other) { return this._Key.CompareTo(other._Key); }
    }
}