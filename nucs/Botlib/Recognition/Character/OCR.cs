...
namespace BotSuite.Recognition.Character {
    ...
    public class OCR {
        ...
        public float[] GetMagicSticksPattern(ImageData Img) { return ImageSense.GetMagicMatchSticksState(Img); }
        ...
        public float[] GetNetworkOutput(float[] input) { return WorkingNeuralNetwork.Output(input); }
