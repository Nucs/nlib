...
namespace nucs.Business {
    public class PetaPocoRepository : IRepository {
        ...
        public TPassType Single<TPassType>(object primaryKey) {
            return db.Single<TPassType>(primaryKey.ToString());
        }
        ...
        public Page<TPassType> PagedQuery<TPassType>(long pageNumber, long itemsPerPage, string sql,
                                                     params object[] args) {
