...
public static partial class StringExtension
{
    ...
    ///     </code>
    /// </example>
    public static T DeserializeJavaScript<T>(this string @this, params JavaScriptConverter[] converters)
    {
        var serializer = new JavaScriptSerializer();
    ...
    ///     </code>
    /// </example>
    public static T DeserializeJavaScript<T>(this string @this, IEnumerable<JavaScriptConverter> converters)
    {
        var serializer = new JavaScriptSerializer();
        serializer.RegisterConverters(converters);
        return serializer.Deserialize<T>(@this);
