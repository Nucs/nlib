...
namespace KeyLogger
{
    public delegate void KeyPressedHandler(UserActivityHook sender, char key, bool ctrl, bool alt, bool shift, Bool handled);
    /// <summary>
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (KeyPress != null && wParam == WM_KEYDOWN) {
                    ...
                    //var k = AKey.Produce(KeyCode.None, mods);
                                ...
                                MyKeyboardHookStruct.flags) == 1)
                    {
                        ...
                        var hand = new Bool(true);
                        KeyPress(this, key, isDownControl,isDownAlt, isDownShift, hand);
                        handled = handled || hand;
                    }
                }
