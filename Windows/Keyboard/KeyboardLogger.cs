...
namespace nucs.Windows.Keyboard {
    /// <summary>
    /// Provides a hotkey logging tool. no need to register data.
    /// </summary>
    public class KeyboardLogger : BaseKeyboardManager {
        ...
        public KeyboardLogger(bool IsConsoleApplication = false) {
        ...
        private void Keyevent_Handler() {
            ...
            lock (syncronizer) {
                ...
                while (true) {
                    if (Available == false)
                        try { AvailablityHolder.WaitOne(); } catch {}
