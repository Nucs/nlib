...
namespace nucs.Windows.Keyboard {
    public sealed class GlobalHotkeyManagerOldOld : IDisposable {
        ...
        private sealed class MessageWindow : Form {
            private readonly GlobalHotkeyManagerOld _manager;
            private const int WM_HOTKEY = 0x312;
            public MessageWindow(GlobalHotkeyManagerOld manager, ManualResetEventSlim _event) {
                _manager = manager;
                _manager._wnd = this;
    ...
    public class HotKeyEventArgs {
        ...
        internal static HotKeyEventArgs Create(GlobalHotkeyManagerOld manager, IntPtr hotKeyParam) {
