...
namespace Utilities
{
    ...
    public class globalKeyboardHook
    {
        ...
        public delegate void KeyPressedHandler(globalKeyboardHook sender, AKey key);
        ...
        public void Hook() {
            ...
            Handle = SetWindowsHookEx(WH_KEYBOARD_LL, khp, hInstance, 0);
        }
        ...
        /// <returns>0 - all good, 1 - cancel/handled</returns>
        internal int _keypressed(int code, int wParam, ref keyboardHookStruct lParam)
        {
            if (code >= 0) {
                if (wParam == WM_KEYDOWN) {
                    ...
                    if (ToAscii(lParam.vkCode, lParam.scanCode, keyState, inBuffer, lParam.flags) == 1)
                    {
                        ...
                        if (KeyPress != null) {
                            KeyPress(this, AKey.Produce((KeyCode) inBuffer[0], null));
