...
namespace nucs.Database {
    ...
    public static class Db {
        ...
        static Db() {
            Dialect=SimpleCRUD.Dialect.SQLServer;
        ...
        #region Settings
        public static void ChangeConnectionString(ConnectionStringSettings connectionstring) {
            if (connectionstring == null)
                throw new ArgumentNullException(nameof(connectionstring));
            ChangeConnectionString(connectionstring.ConnectionString);
        }
        ...
        /// <summary>
        ///     Creates a using for dbconnection and calls sqlfunc inside on it parallely.
        /// </summary>
        /// <typeparam name="T">Return type</typeparam>
        /// <param name="sqlfunc">Method that uses sql connection</param>
        /// <returns></returns>
        public static ManualResetEventSlim CallAsync(Action<SqlConnection> sqlfunc) {
