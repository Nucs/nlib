...
/*        public static Task<Task<TResult>> WhenAny<TResult>(this ICollection<Task<TResult>> tasks) {
    ...
    internal class VoidTask : IDisposable {
    ...
    internal class Task<R> : IDisposable {
    ...
    /// </summary> 
    [Serializable]
    internal class TaskCanceledException : OperationCanceledException {
        //[NonSerialized]
    ...
    internal class WaitHandleTimeout : Exception {
